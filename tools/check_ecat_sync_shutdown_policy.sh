...
fixed_contains '0004-use-component-parameters-for-ec-modules.patch' "${dockerfile}" ||
  fail "Dockerfile must apply the typed EtherCAT HardwareInfo patch"
fixed_contains '0005-validate-component-module-parameters.patch' "${dockerfile}" ||
...
if [[ -n "${ECAT_ICUBE_SOURCE:-}" ]]; then
  ...
  for patch in \
    ...
    0004-use-component-parameters-for-ec-modules.patch \
    0005-validate-component-module-parameters.patch
  do
