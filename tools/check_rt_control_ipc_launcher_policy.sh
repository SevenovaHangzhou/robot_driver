...
for required in \
  ...
  'readonly runtime_sha="e4fed685bfa4485c210ad038c804a331b4801d88"' \
  'readonly runtime_image_id="sha256:998c5a1e9e5f70f7e09f1f2a8c316bbc3714bd9815e68f6b870130a332542c06"' \
  'ENABLE_RT_CONTROL' \
