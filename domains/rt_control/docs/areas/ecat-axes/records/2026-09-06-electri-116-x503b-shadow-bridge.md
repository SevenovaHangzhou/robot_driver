...
verified: PARTIAL
evidence:
  - "x503_force_sensor package build and colcon test: 2 test targets / 11 cases, 0 failures"
  - "affected native-source build: 29 packages finished"
  - "affected colcon test-result: 1436 tests, 0 errors, 0 failures, 18 skipped"
...
- `colcon test --packages-select x503_force_sensor`：2 test targets / 11 cases，0 failures。
- 受影响 native-source build：29 packages finished，0 failures。
- 受影响全量 `colcon test-result`：1436 tests，0 errors，0 failures，18 skipped；Mock launch
