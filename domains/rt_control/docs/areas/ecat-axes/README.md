...
| # | 事实 | 来源 | 状态 |
| --- | --- | --- | --- |
| F1 | 四舵轮功能分支为八电机 EtherCAT + 四外置编码器 CANopen，未并入十四轴生产入口 | [ecat-axes-20260912-01](records/2026-09-12-swerve-phase8-sync.md) | 源码同步，实机未验收 |

## 记录索引（倒序）

- [2026-09-12 — 四舵轮 Phase 7.5/8 同步](records/2026-09-12-swerve-phase8-sync.md)
