...
| # | 事实 | 来源 | 状态 |
| --- | --- | --- | --- |
| F1 | 履带主动轮半径 `0.1044 m`（直径 `0.2088 m`）、轮距 `1.9598 m`；Node 2/3 位置与速度 to-device 比例均为 `-609789.0539919361`，逆比例均为 `-1.63991136517387e-6`；diff-drive 逻辑半径保持 `1.0` | BQ-139；[2026-08-21 记录](records/2026-08-21-track-mechanics-1044mm-19598mm.md) | 已裁决，待 T4 实车比例复验 |
