...
| F13 | 12份CAD原件仅在精确路径与SHA-256匹配时接受原始无末尾换行格式；包含原8份和新增机械惯性4份，其他门禁仍执行 | [原件字节保留](records/2026-09-25-description-snapshot-byte-preservation.md)#F1-F2；[惯性来源登记](records/2026-09-25-inertial-source-byte-preservation.md)#F1 | 本地回归通过，完整CI待执行 |

## 记录索引（倒序）

- 2026-09-25 [ELECTRI-136 新机械惯性原件字节保留](records/2026-09-25-inertial-source-byte-preservation.md) — fix，UNVERIFIED（T0）
